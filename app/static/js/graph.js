...
function updateData(newData) {
	// Maximum data entries we will be working with
	const MAX_DATA = 10
	...
	if(length == MAX_DATA) {
		...
		chart.data.datasets[0].data[length - 1] = newData	
	}
...
// Once app is connected to csv file or database to get data from there instead
function getData() {
